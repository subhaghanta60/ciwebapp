...
<form method="post" name="Agency Login Form" class="was-validate" action="<?php echo base_url().'Agency/A_login/login_agency';?>">
<div class="row">
<div class="col-lg-6">
...
<div class="col-lg-6">
<div class="form-group">
<a href=" <?php echo base_url().'Agency/A_registration/registration' ?> " type="submit"class="btn btn-primary"> Agency Sign Up</a>
</div>
</div>
</div>
